...
from qgis.core import (QgsCoordinateReferenceSystem, QgsCoordinateTransform,
                       ...
                       QgsFillSymbol, QgsPalLayerSettings, QgsVectorLayerSimpleLabeling, QgsTextFormat)
...
class ResultCollector:
    ...
    def default_layer_factory(cls, name = "Wyniki wyszukiwania ULDK",
        ...
        symbol = QgsFillSymbol.createSimple({'border_width_map_unit_scale': '3x:0,0,0,0,0,0',
                                             'color': '255,255,255,0',
                                             'joinstyle': 'bevel', 'offset': '0,0',
                                             'offset_map_unit_scale': '3x:0,0,0,0,0,0',
                                             'offset_unit': 'MM',
                                             'outline_color': '60,160,255',
                                             'outline_style': 'solid',
                                             'outline_width': '0.26',
        ...
        label_settings.fieldName = 'nr_dzialki'
        label_settings.drawLabels = True

        text_format = QgsTextFormat()
        text_format.setSize(9)
        text_format.setColor(QColor(60,160,255))
